...
import { FiHome, FiChevronRight, FiBook } from 'react-icons/fi'

/**
 * AcademicsHero
 * ─────────────
 * Full-width hero banner for the Academics page.
 * Features: blurred school background image, dark overlay, animated breadcrumb,
 * page title, short description, and animated accent bar.
 */
const AcademicsHero = () => {
  return (
    <section className="relative w-full h-[420px] md:h-[480px] flex items-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          <span className="text-amber-400 font-semibold">Academics</span>
        </motion.nav>
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-none">
            Aca<span className="text-amber-400">demics</span>
          </h1>

          <p className="text-emerald-300/70 mt-5 text-base md:text-lg max-w-xl leading-relaxed font-light">
            A rigorous, future-ready curriculum designed to spark curiosity,
            develop critical thinking, and prepare every student for a rapidly
            evolving world.
          </p>
        </motion.div>
