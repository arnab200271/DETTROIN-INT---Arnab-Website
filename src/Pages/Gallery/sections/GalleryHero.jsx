 ...
 * GalleryHero
 * ───────────
 * Hero banner for the Gallery page featuring campus photography background,
 * dark gradient overlay, page title, breadcrumb navigation, and accent line.
 */
const GalleryHero = () => {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        ...
        >
          ...
          <p className="text-emerald-300/70 mt-5 text-base md:text-lg max-w-xl leading-relaxed font-light">
            Explore campus life, cultural celebrations, athletic achievements, and vibrant
            stories from our student community through photos, videos, and articles.
          </p>
        </motion.div>
